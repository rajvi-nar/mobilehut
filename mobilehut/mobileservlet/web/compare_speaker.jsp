<%-- 
    Document   : compare_speaker
    Created on : Jul 8, 2014, 3:42:56 AM
    Author     : Rajvi
--%>
...
<div><form action="result_speaker.jsp"><center>
<br>
<div>
...
<select name="one">
  <option  value="digiflip">digiflip PS004</option>
  <option  value="jbl">jbl PULSE</option>
  <option  value="skullcandy">skullcandy X7R</option>
  <option  value="lenovo">lenovo USB</option>
</select>
 </div>
