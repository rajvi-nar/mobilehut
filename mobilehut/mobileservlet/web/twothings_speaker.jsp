<%-- 
    Document   : twothings_speaker
    Created on : Jul 8, 2014, 3:33:40 AM
    Author     : Rajvi
--%>
...
%><br><br>
            ...
            <menu><center>
                    <div >choose one option:<br>
                        <a href="compare_speaker.jsp"><img src="images/compare2.jpg"  width="194" height="150"></a>
                        <a href="sell_speaker.jsp"><img src="images/sell.jpg"  width="194" height="150"></a></p>
                    </div>
                </center></menu>
        </div>
        ...
        <div id="footer">
            <menu><center>
                    ...
                    <a href="sell_speaker.jsp">sell your speakers</a> <br>
