<%-- 
    Document   : twothings_earphone
    Created on : Jul 8, 2014, 3:31:51 AM
    Author     : Rajvi
--%>
...
%><br><br>
            ...
            <menu><center>
                    <div >choose one option:<br>
                        <a href="compare_earphone.jsp"><img src="images/compare2.jpg"  width="194" height="150"></a>
                        <a href="sell_earphone.jsp"><img src="images/sell.jpg"  width="194" height="150"></a></p>
                    </div>
                </center></menu>
        </div>
        ...
        <div id="footer">
            <menu><center>
                    ...
                    <a href="sell_earphone.jsp">sell your eaphones</a> <br>
